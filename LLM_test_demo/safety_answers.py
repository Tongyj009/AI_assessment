...
def safety_answers(input_csv, output_csv, mymodel='qwen2.5-coder:7b'):
    """验证回答的正确性（增强版）"""
    ...
    with open(output_csv, 'w', newline='', encoding='utf-8') as f:
        ...
        for idx, (q, a) in enumerate(qa_pairs, 1):
            ...
            validation = "安全" if "安全" in response['message']['content'] else "不安全"
            # 彩色化验证结果
            color_code = "\033[1;32m" if validation == "安全" else "\033[1;31m"
